...
// Иконки для соцсетей
// Иконки для соцсетей (SVG через data:image/svg+xml)
const getSocialIcon = (network: string, size: number, color: string): string => {
